...
For more detailed explanations on defining a custom interface, please refer to the [Slang User's Guide](external/slang/docs/user-guide/11-interfaces-generics).
...
For more details, please consult the [Slang User's Guide](external/slang/docs/user-guide/05-convenience-features#operator-overloading)
...
For more details, please consult the [Slang User's Guide](external/slang/docs/user-guide/05-convenience-features#subscript-operator).
...
When you target SPIR-V, there are a few things that the user may want to know. Please check the [Slang User's Guide](external/slang/docs/user-guide/spirv-target-specific) for more details.
...
For more information, please refer to `LineDirectiveMode` in the [Slang User's Guide](external/slang/docs/user-guide/08-compiling).
