...
In such cases, developers are encouraged to read the other [documentation](external/slang/docs/user-guide/reflection.md) that exists for the Slang reflection API.
