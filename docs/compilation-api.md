...
Here is where you can specify Session-wide options. Check the [User Guide](external/slang/docs/user-guide/08-compiling.md#compiler-options) for info on available options.
...
Check the [User Guide](external/slang/docs/user-guide/09-reflection.md#program-reflection) for info.
...
API methods for module precompilation are described in the [User Guide](external/slang/docs/user-guide/10-link-time-specialization.md#using-precompiling-modules-with-the-api).
...
[User Guide](external/slang/docs/user-guide/10-link-time-specialization.md#link-time-types)
...
See [Reflection API Tutorial](external/slang/docs/user-guide/09-reflection.md) for more details.
